...
Ocultar_asm: ; rdi= *src, rsi = *src2, rdx = *dst, ecx=with,r8d=height,r9d=src_row_size,[rsp+8]=dst_row_size  
	...
	.ciclo:
		...
		movdqu xmm6, [mask_bitsMirror]; xmm6=|0|12|12|12|.....|0|12|12|12|
		...
		movdqu xmm8,xmm4
		movdqu xmm9, [mask_primerBitRojo]
		...
		movdqu xmm10, xmm4
		movdqu xmm9, [mask_segundoBitRojo]
		...
		movdqu xmm1,xmm4 
		movdqu xmm9,[mask_primerBitVerde]
		...
		movdqu xmm2, xmm4
		movdqu xmm9, [mask_segundoBitVerde]
		...
		movdqu xmm3,xmm4 ;  
		movdqu xmm9,[mask_primerBitAzul]
		...
		movdqu xmm5,xmm4 ;  
		movdqu xmm9,[mask_segundoBitAzul]
