...
Descubrir_asm:; rdi= *src, rsi = *dst, edx = with,ecx=height,r8d=src_row_size,  r9d=dst_row_size
	...
	.ciclo:
		...
		movdqa xmm3, [mask_bitsParaArmar]
		pand xmm1, xmm3
		...
		movdqa xmm4,[mask_blueBit7]
		pand xmm4, xmm1
		psllw xmm4,7 ; ubico el bit	7 para color

		movdqa xmm5, [mask_blueBit4]
		pand xmm5, xmm1
		...
		movdqa xmm6, [mask_greenBit6] 
		pand xmm6, xmm1
		movdqa xmm5,[mask_reubicarGreen]
		...
		movdqa xmm10, [mask_setearbits]
		pand xmm4, xmm10

		; Reubico los grises en cada componente
		movdqa xmm12, [mask_reubicar]
		pshufb xmm4,xmm12

		;seteo la tranparencia
		movdqa xmm11,[mask_transparencia]
		por xmm4, xmm11
